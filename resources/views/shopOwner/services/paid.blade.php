                ...
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex gap-3 align-items-center">
                            <a href="{{route('shop.owners.services.avail')}}" class="btn btn-success btn-sm">View Paid Service</a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        {{ $service->status ? 'Paid' : 'Pending' }}</p>
                                                </td>
                                                <td class="align-middle text-center">
                                                    @if($service->status)
                                                    <form action="{{ route('shop.owners.update.services.status', $service->id) }}" method="POST">
                                                        @csrf
                                                        <button
                                                            class="text-secondary font-weight-bold text-xs btn btn-sm btn-danger text-light"
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="4" class="text-center p-5">No Services Avalied yet</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
