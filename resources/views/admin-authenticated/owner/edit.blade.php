                    ...
                    <div class="row gx-4">
                        <div class="col-auto">
                            <div class="avatar avatar-xl position-relative">
                                <img src="{{asset((new \App\Helper\Helper())->userAvatar($shopOwner->avatar))}}" alt="profile_image"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('password') is-invalid @enderror" type="password" name="password"
                                                value="{{ old('password', $shopOwner->password) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('address') is-invalid @enderror" type="text" name="address" value="{{ old('address', $shopOwner->address) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="h6 font-weight-300">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 mt-5">
                                                <p><small id="shopAddress">{{$shopOwner->shopOwnerInfo->shopAddress}}</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
        var map = L.map('map').setView([{{$shopOwner->shopOwnerInfo->shopLat}}, {{$shopOwner->shopOwnerInfo->shopLong}}], 16);
